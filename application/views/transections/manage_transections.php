             ...
             <?php echo form_open_multipart("Transections/validate"); ?>
                        ...
                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <?php echo form_input('tt_name', set_value('tt_name',$result['tt_name']), 'id="tt_name" class="form-control" placeholder="Transaction Type"'.$dis.' '.$o_dis.' '); ?>
                    ...
                    <div class="box-footer">
                          <!--<butto style="z-index:1" n class="btn btn-default">Clear Form</button>-->
                                    ...
                                    <?php echo form_submit('submit','Void Transaction','class="btn btn-primary"'); ?>&nbsp;
