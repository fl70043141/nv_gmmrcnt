...
<div class="col-md-12">
    ...
    <div class="col-md-12">
        ...
        <div class="">
            ...
            <?php echo ($this->user_default_model->check_authority($this->session->userdata(SYSTEM_CODE)['user_role_ID'], $this->router->class, 'cons_rec_print'))?'<a target="_blank" href="'.base_url($this->router->fetch_class().'/cons_rec_print/'.$cs_data['id']).'" class="btn btn-app "><i class="fa fa-print"></i>Print Sheet</a>':''; ?>
