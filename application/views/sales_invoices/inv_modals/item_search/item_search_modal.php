            ...
            <div class="box-body">
                <div class="col-md-4"> 
                    <div class="form-group">
                      <label for="search_item_category_id" class=" control-label">Variety</label>
                ...
                <div class="col-md-4">
                     <div class="form-group">
                        <label for="search_item_units" class="control-label">Units</label> 
                        <input  type="search_item_units" name="search_item_units" class="form-control input-lg" id="search_item_units" placeholder="Search by Weight..">
                    </div> 
                </div>
...
<script>
    $(document).ready(function(){
       $('#itm-line-search').click(function(){ 
...
//		});
            $.ajax({
			url: "<?php echo site_url('Sales_invoices/fl_ajax');?>",
			type: 'post',
