...
//                                                            echo '<pre>';print_r($cr_data);  
                                                    foreach ($cr_items as $cr_item){
                                                        $unit1= ($cr_item['commision_unit']>0)?($cr_item['item_quantity']-$cr_item['commision_unit']):$cr_item['item_quantity'];
                                                        $unit2= ($cr_item['commision_unit_2']>0)?($cr_item['item_quantity_2']-$cr_item['item_quantity_2']):$cr_item['item_quantity_2'];
                                                            
                                                        if($unit1 > 0){
                                                            $sub_tot_actual = $cr_item['unit_price'] * $unit1;
