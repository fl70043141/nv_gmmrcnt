                                                                      ...
                                                                      '<div class="col-md-12 bg-gray " style="padding: 20px 0 20px; ">';
                                                                        ...
                                                                        content += '<div class="preview col-md-6">'+
                                                                                ...
                                                                                if(cert_images.length>0){
                                                                                    $.each(cert_images, function (key_cert, crt_img_name) {
                                                                                        content +=   '<div class="tab-pane" id="'+item_obj.item_id+'-pic-'+i+'"><img style="width:'+(window.innerWidth)+'px;" src="'+img_dir+item_obj.item_id+'/certificates_files/'+crt_img_name+'" /></div>';
                                                                                        i++;
                                                                                    });
                                                                                } 
                                                                        ...
                                                                        if(item_obj.is_gem == 1){
                                                                            ...
                                                                            content +=  '<h3 hidden class="price">Price: <span>'+((typeof(item_obj.item_price_info.currency_code) != 'undefined')?item_obj.item_price_info.currency_code:'')+' '+ ((typeof(item_obj.item_price_info.price_amount) != 'undefined')?item_obj.item_price_info.price_amount:'--')+'</span></h3>'+
                                                                                         '<input hidden id="'+item_obj.item_id+'_amountinpt" name="item_tmp['+item_obj.item_id+'][unit_price]" type="number" min="0" value="'+((typeof(item_obj.item_price_info.price_amount) != 'undefined')?item_obj.item_price_info.price_amount:'0')+'" class="form-group input-lg col-sm-8 col-xs-8 amount_inpt">'+
                                                                                         ...
                                                                                         '<div hidden class="quantity buttons_added row pad" >'+
                                                                                         ...
                                                                                         '<div class="action row">'+
                                                                                                    '<div class="col-md-12 col-xs-12 col-sm-12"> <a onclick="window.close()"class="like btn btn-default  btn-block" type="button"><span class="fa fa-backward"></span> Back</a> </div>'+
                                                                                                    '<div class="hide col-md-6  col-xs-6 col-sm-6"> <a  id="'+item_obj.item_id+'_addcartbtn"  class="add-to-cart btn btn-default pull-right  btn-block bg-blue" type="button"><span class="fa fa-plus"></span> add to order</a> </div>'+
                                                                                         '</div>'+
                                                                                 '</div>'+
                                                                              '</div>'+
                                                                         '</div>'+
