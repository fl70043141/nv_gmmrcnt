                                                        ...
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="caption" >
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xs-12 col-md-12 ">
                                                                        <a id="'.$item['item_id'].'_btn_view"  target="_blank" href="'.base_url($this->router->fetch_class().'/view_item/'.$item['item_id'].'/'.$item['item_category_id'].'_'.$order_id.'_'.$price_type_id.'/'.$page_no).'" class="itm_btn_view btn btn-default center-block "  >View</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
