...
//                                            echo '<pre>';print_r($item); die;
                                            echo '
                                                    <div class="item image-grid__item no-padding">
                                                        <div class="thumbnail">
                                                            <a target="_blank" href="'.base_url($this->router->fetch_class().'/view_item/'.$item['item_id'].'/'.$category_id.'_'.$order_id.'_'.$price_type_id.'/'.$page_no).'"><img class="group list-group-image img-bordered-sm" style="width:400px;" src="'.base_url(ITEM_IMAGES.(($item['image']!='')?$item['item_id'].'/'.$item['image']:'../default/default.jpg')).'" alt="" /></a>
                                                            <div class="caption" >
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div hidden class="col-xs-12 col-md-12 ">
