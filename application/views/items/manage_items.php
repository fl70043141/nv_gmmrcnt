 ...
 <br>
        <div class="col-md-12">
            ...
            <div class="top_links">
                ...
                <?php echo $this->user_default_model->check_authority($this->session->userdata(SYSTEM_CODE)['user_role_ID'], 'Purchasing_gemstones', 'print_barcode_purchase')?'<a target="_blank" href="'.base_url('Purchasing_gemstones/print_barcode_purchase/'.$result['id']).'" class="btn btn-app  '.(($action=='Delete')?'hide ':'').' "><i class="fa fa-barcode"></i>Print</a>':''; ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="nav-tabs-custom">
                                  <ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#tab_5" data-toggle="tab">Transaction</a></li>
