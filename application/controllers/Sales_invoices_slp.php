...
class Sales_invoices_slp extends CI_Controller {
...
//            echo '<pre>';            print_r($this->get_invoice_info($inv_id)); die; 
            ...
            $company_id = $this->session->userdata(SYSTEM_CODE)['company_id'];
            $company_dets = get_single_row_helper(COMPANIES,'id = '.$company_id);
            $company_origin = get_single_row_helper(COUNTRY_LIST,"country_code = '".$company_dets['country']."'");
            
            $def_curcode = $this->session->userdata(SYSTEM_CODE)['default_currency'];
            $def_cur_det = get_currency_for_code($def_curcode);
            
//            echo '<pre>';            print_r($company_origin); die; 
...
//            echo '<pre>';            print_r($inv_dets); die;
            ...
            $html .= '<table style="padding:2;" border="0.0"> 
                        <tr><td>
                            ...
                            <tr>
                                <td style="padding:10px;"></td> 
                                <td align="right">Gen License No: '.$company_dets['company_grade'].'</td> 
                            </tr>   
                            <tr>
                                <td style="padding:10px;"></td> 
                                <td align="right">Business Reg No: '.$company_dets['reg_no'].'</td> 
                            </tr>   
                        </table> 
                    </td></tr>
                    </table> ';
...
//                            echo '<pre>';            print_r(count($inv_data['invoice_desc_list'])); die;
            $html .= '<table border="0">
                            ...
                            <tr>
                                <td align="left">Delivered by: EMS</td> 
                                <td align="center"></td> 
                            ...
                            <tr>
                                <td align="left">Terms of Payments: Consignment Basis</td> 
                                <td align="center"></td> 
                                <td align="right">Rate: '. number_format($def_cur_det['value']/$cur_det['value'],4).'</td> 
                            </tr>  
                            <tr><td  colspan="3"><br></td></tr>
                        </table>  ';
...
//                           </table>  ';            
            ...
            $pdf->writeHTML($html);
             ...
             $bank_details = '<table style="padding-left:20px;" border="0">
                                    ...
                                    <tr><td colspan="1">Swift Code: HBLILKLX</td></tr> 
                                    <tr><td colspan="1"></td></tr> 
                                    
                                    <tr><td colspan="1">Branch Name: Hatton National Bank Plc - Beruwela Branch</td></tr> 
                                    <tr><td colspan="1">Branch Address: 187, Galle Road, Beruwela</td></tr> 
                                    <tr><td colspan="1">Branch Code: 160</td></tr> 
                                    <tr><td colspan="1"></td></tr> 
                                    
                                    <tr><td colspan="1">Account Name: Insaaf M I M</td></tr> 
                                    <tr><td colspan="1">Account Number: 160010016160</td></tr> 
                                    <tr><td colspan="1"></td></tr> 
                                    

                                    <tr><td colspan="1">Personal Details</td></tr> 
                                    <tr><td colspan="1">Account Holder Address: 12, Sheikh Ibrahim Mawatha, China Fort, Beruwela</td></tr> 
                                    <tr><td colspan="1">National Id Number: 910180223V</td></tr> 
