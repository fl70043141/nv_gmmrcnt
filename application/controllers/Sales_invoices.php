...
//                    echo '<pre>';                    print_r($cust_dets); die;
        ...
        function sales_invoice_print_pp($inv_id,$tmp_mail=''){
            $this->load->model('Sales_orders_model');
            $print_option = $this->input->get();
			if(isset($print_option['prnt_optn']) && !empty($print_option['prnt_optn']))
				$print_option = json_decode($print_option['prnt_optn']);
            ...
            $cust_html = '
                            <table style="padding:2;" border="0"> 
                                <tr><td>
                                    <table style="padding:0 50 2 0;">  
                                    <tr>
                                        <td style="padding:10px;">'.$inv_dets['customer_name'].' ('.$inv_dets['short_name'].')</td> 
                                    </tr>   
                                    <tr>
                                        <td style="padding:10px;">'.(($inv_dets['address']!='')?$inv_dets['address'].', ':'').(($inv_dets['city']!='')?$inv_dets['city']:'').'</td> 
                                    </tr>   
                                    <tr>
                                        <td style="padding:10px;">'.(($cust_dets['phone']!='')?''.$cust_dets['phone']:'').'</td> 
                                    </tr> 
                        </table> 
                    </td></tr>
                    </table> ';
...
//                            echo '<pre>';            print_r(count($inv_data['invoice_desc_list'])); die;
            $html .= '<table border="0" style="padding:0 0 0 8;"> 
                            <tr>
                                <td align="left">TRX Type: '.$inv_dets['invoice_type'].'</td> 
                                <td align="center">Invoice Date '.date(SYS_DATE_FORMAT,$inv_dets['invoice_date']).'</td> 
                                <td align="right">Invoice  No: '.$inv_dets['invoice_no'].'</td> 
