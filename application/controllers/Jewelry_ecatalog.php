...
class Jewelry_ecatalog extends CI_Controller {
        ...
        public function index($so_id=''){
            ...
            $data['order_id'] = $so_id;
            $data['main_content']='sales/jewelry_catelog/category_grid';  
        ...
        public function item_list($cat_id="", $page_no='1'){
            ...
            $data['main_content']='sales/jewelry_catelog/item_grid';  
            $this->load->view('includes/template',$data);
	}
...
//                    echo '<pre>';            print_r($inputs); die;
            ...
            $data['main_content']='sales/jewelry_catelog/item_grid_img_loader';  
            $this->load->view('includes/template',$data);
	}
...
//		$data_view['search_list'] = $this->Order_ecataog_modal->search_result();
            $this->load->view('sales/jewelry_catelog/category_grid_result',$data);
	}
...
//            echo '<pre>';            print_r($data); die;
            $this->load->view('sales/jewelry_catelog/item_grid_result',$data);
	}
...
//            $this->load->view('sales/jewelry_catelog/item_single_view');
            ...
            $data['main_content']='sales/jewelry_catelog/item_single_view';  
