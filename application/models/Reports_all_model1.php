...
------------------------------------------------------------*/
    public function get_expenses($data,$where=''){
        ...
        $this->db->join(GL_CHART_MASTER.' cm','cm.account_code = qa.debit_gl_code AND (cm.account_type_id = 11 OR cm.account_type_id = 12 OR cm.account_type_id=13 OR cm.account_type_id=14 OR cm.account_type_id=15)','left'); //12: gen expense 13: lab charges, 14: BKK
